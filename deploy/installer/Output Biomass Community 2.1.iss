...
Source: {#BuildDir}\Landis.Extension.Output.BiomassCommunity-v2.1.dll; DestDir: {#ExtDir}; Flags: ignoreversion
Source: {#BuildDir}\Landis.Extension.Output.BiomassCommunity-v2.1.pdb; DestDir: {#ExtDir}; Flags: ignoreversion
...
#define InfoTxt "Output Biomass Community 2.1.txt"
Source: {#InfoTxt}; DestDir: {#LandisPlugInDir}
; NOTE: Don't use "Flags: ignoreversion" on any shared system files


[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Output Biomass Community v2.1"" "; WorkingDir: {#LandisPlugInDir}
